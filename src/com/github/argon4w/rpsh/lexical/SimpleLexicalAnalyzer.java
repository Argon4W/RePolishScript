package com.github.argon4w.rpsh.lexical;

import com.github.argon4w.rpsh.lexical.tokens.*;
...
public class SimpleLexicalAnalyzer {
    ...
    public List<IToken> tokenize(String inputShellCode) {
        ...
        characters = inputShellCode.toCharArray();
        index = 0;
