...
import com.github.argon4w.rpsh.runtime.instrutions.object.OfInstruction;
...
public class OfSyntaxTreeNode implements ISyntaxTreeNode {
    ...
    public List<IInstruction> getInstructions() {
        ...
        instructions.add(new OfInstruction());
