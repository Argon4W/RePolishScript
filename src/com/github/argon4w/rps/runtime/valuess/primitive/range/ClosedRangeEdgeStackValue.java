...
public record ClosedRangeEdgeStackValue(INumericStackValue value) implements IRangeEdgeStackValue {
    @Override
    ...
    public boolean equals(IStackValue right) {
        return right instanceof ClosedRangeEdgeStackValue edgeValue && value.equals(edgeValue.value);
    }
}
