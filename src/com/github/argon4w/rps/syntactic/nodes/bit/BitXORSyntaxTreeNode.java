...
import com.github.argon4w.rps.runtime.instrutions.bit.BitXORInstruction;
...
public class BitXORSyntaxTreeNode implements ISyntaxTreeNode {
    ...
    public List<IInstruction> compile(RePolishCompiler compiler) {
        ...
        instructions.add(new BitXORInstruction());
