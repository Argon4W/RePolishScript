...
import com.github.argon4w.rps.runtime.instrutions.bit.BitOrInstruction;
...
public class BitOrSyntaxTreeNode implements ISyntaxTreeNode {
    ...
    public List<IInstruction> getInstructions() {
        ...
        instructions.add(new BitOrInstruction());
