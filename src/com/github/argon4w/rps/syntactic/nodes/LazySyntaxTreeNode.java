...
import com.github.argon4w.rps.runtime.instrutions.LazyInstruction;
...
public class LazySyntaxTreeNode implements ISyntaxTreeNode {
    ...
    public List<IInstruction> compile(RePolishCompiler compiler) {
        ...
        instructions.add(new LazyInstruction());
