...
import com.github.argon4w.rps.runtime.instrutions.assign.FallbackAssignInstruction;
...
public class FallbackAssignSyntaxTreeNode implements ISyntaxTreeNode {
    ...
    public List<IInstruction> compile(RePolishCompiler compiler) {
        ...
        instructions.add(new FallbackAssignInstruction());
