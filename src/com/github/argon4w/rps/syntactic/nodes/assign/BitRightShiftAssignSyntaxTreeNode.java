...
import com.github.argon4w.rps.runtime.instrutions.assign.BitRightShiftAssignInstruction;
...
public class BitRightShiftAssignSyntaxTreeNode implements ISyntaxTreeNode {
    ...
    public List<IInstruction> compile(RePolishCompiler compiler) {
        ...
        instructions.add(new BitRightShiftAssignInstruction());
