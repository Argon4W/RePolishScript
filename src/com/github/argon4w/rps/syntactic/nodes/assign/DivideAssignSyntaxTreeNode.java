...
import com.github.argon4w.rps.runtime.instrutions.assign.DivideAssignInstruction;
...
public class DivideAssignSyntaxTreeNode implements ISyntaxTreeNode {
    ...
    public List<IInstruction> compile(RePolishCompiler compiler) {
        ...
        instructions.add(new DivideAssignInstruction());
