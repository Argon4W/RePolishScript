...
import com.github.argon4w.rps.runtime.instrutions.assign.AddAssignInstruction;
...
public class AddAssignSyntaxTreeNode implements ISyntaxTreeNode {
    ...
    public List<IInstruction> compile(RePolishCompiler compiler) {
        ...
        instructions.add(new AddAssignInstruction());
