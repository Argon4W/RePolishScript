...
import com.github.argon4w.rps.runtime.instrutions.object.ShortCircuitFallbackInstruction;
...
public class ShortCircuitFallbackSyntaxTreeNode implements ISyntaxTreeNode {
    ...
    public List<IInstruction> compile(RePolishCompiler compiler) {
        ...
        instructions.add(new ShortCircuitFallbackInstruction());
