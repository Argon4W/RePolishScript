...
import com.github.argon4w.rps.runtime.instrutions.operands.PushVaParameterInstruction;
import com.github.argon4w.rps.syntactic.ISyntaxTreeNode;

import java.util.List;
import java.util.Stack;

public class PushVaParameterSyntaxTreeNode implements ISyntaxTreeNode {
    @Override
    ...
    public List<IInstruction> compile(RePolishCompiler compiler) {
        return List.of(new PushVaParameterInstruction());
    }
}
