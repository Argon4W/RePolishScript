...
import com.github.argon4w.rps.runtime.instrutions.condition.NotEqualsInstruction;
...
public class NotEqualsSyntaxTreeNode extends AbstractConditionSyntaxTreeNode {
    ...
    public List<IInstruction> compileNonChained(RePolishCompiler compiler) {
        ...
        instructions.add(new NotEqualsInstruction());
