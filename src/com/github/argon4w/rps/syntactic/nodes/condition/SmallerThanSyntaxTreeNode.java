...
import com.github.argon4w.rps.runtime.instrutions.condition.SmallerThanInstruction;
...
public class SmallerThanSyntaxTreeNode extends AbstractConditionSyntaxTreeNode {
    ...
    public List<IInstruction> compileNonChained(RePolishCompiler compiler) {
        ...
        instructions.add(new SmallerThanInstruction());

        return instructions;
    }

    public ISyntaxTreeNode setLeft(ISyntaxTreeNode left) {
        this.left = left;
        return this;
    }
